...
Dalam menjelaskan fungsi dan unit kerja, CSO menggunakan pendekatan PPT (People, Process, and Technology). Pendekatan ini mengakui bahwa langkah-langkah keamanan yang efektif memerlukan integrasi seimbang dari tiga elemen penting: Manusia, Proses, dan Teknologi. Komponen pertama adalah manusia (people), yang mencakup organisasi CSO, pelatihan mengenai security awareness, dan sosialisasi mengenai security policy kepada nasabah dan pegawai. Komponen kedua adalah proses, yang mencakup peraturan standar dan prosedur security, manajemen risiko security, physical security, dan manajemen perihal userid/identity. Untuk melaksanakan proses tersebut, diperlukan komponen teknologi yang menunjang, seperti anti-DDOS, web application firewall, next-generation firewall, anti-malware, dan pengelolaan user akses menggunakan PAM dan IAM. Melalui tiga komponen tersebut, strategi CSO diterapkan menjadi jobdesk, ketentuan operasional, dan kegiatan operasional di setiap departemen CSO.
