...
1. Data Upstream: Bertanggung jawab atas pengelolaan data dari sumber data internal dan eksternal bank, serta memproses data tersebut untuk digunakan dalam analisis bisnis.
2. Data Downstream: Bertanggung jawab atas pengambilan dan pemindahan data dari berbagai sumber sistem BSI ke database BSI melalui proses ETL menggunakan tools seperti Talend.
3. Data Quality Management: Memastikan kualitas data yang digunakan dalam analisis bisnis dengan melakukan pembaruan, pembersihan, dan integrasi data.
4. Data Mapping and Integration: Mengidentifikasi, memetakan, dan mengelola data internal dan eksternal bank sesuai dengan klasifikasi dan struktur data yang telah ditentukan.
5. Data Architecture: Memastikan arsitektur data mendukung penyusunan strategi bank dan pencapaian tujuan bisnis.
...
Bisnis proses di Departemen Information Management (IM) dapat dilihat pada Gambar x. Bisnis proses tersebut terbagi menjadi basis proyek dan basis Ad Hoc. Berikut adalah penjelasan dari masing-masing proses tersebut:

#### Basis Proyek

1. Data Request: Tim IM berkomunikasi dengan pemohon data untuk memahami tujuan bisnis dan informasi yang diharapkan dari dashboard.
2. Project: Tim IM mengembangkan rencana kerja yang mencakup tahapan analisis, desain, pengembangan, pengujian, dan implementasi dashboard.
3. Dashboard Development: Tim IM mengumpulkan, membersihkan, dan memproses data yang dibutuhkan untuk menghasilkan informasi dalam bentuk dashboard menggunakan Power BI.
4. Maintenance: Tim IM melakukan pemeliharaan dan pemantauan dashboard untuk memastikan data yang digunakan akurat dan relevan. Dashboard diperbarui sesuai dengan perubahan struktur data atau kebutuhan bisnis.
5. User: Tim IM memberikan akses kepada user untuk menggunakan dashboard yang telah dibuat dan memberikan panduan terkait penggunaannya.

#### Basis Ad Hoc

1. Data Request: Tim IM menerima permintaan data mendadak dari user yang membutuhkan informasi tambahan.
2. Ad-hoc: Tim IM merancang dan mengeksekusi query database menggunakan SQL dengan alat seperti Hive atau Dbeaver untuk mengekstrak data yang diminta.
3. Query: Setelah data diekstrak, langkah berikutnya adalah mengekspor data ke format yang sesuai dengan kebutuhan pengguna, seperti Excel atau CSV.
4. Export Data: Tim IM menyediakan hasil ekspor data kepada user untuk analisis lebih lanjut atau penyusunan laporan.
5. User: Tim IM menyediakan hasil ekspor data kepada user yang membutuhkan informasi tersebut untuk analisis lebih lanjut atau kebutuhan lainnya.

### Data Analytics

Bisnis proses di Departemen Data Analytics (DA) dapat dilihat pada Gambar x. Berikut adalah penjelasan dari masing-masing proses tersebut:

1. Business Problem Definition: Tahap pertama proses bisnis di Departemen DA adalah mengidentifikasi dan memahami kebutuhan bisnis. Pemahaman mengenai hasil bisnis yang diinginkan akan menentukan persyaratan data dari segi sumber, kualitas, relevansi, dan ketepatan waktu. Semakin baik pemahaman atas kebutuhan bisnis, semakin besar kemungkinan keberhasilan atau kegagalan inisiatif analisis data. Di tahap ini, DA akan mengadakan pertemuan dengan unit kerja terkait untuk menentukan kebutuhan bisnis dan pemahaman yang akan dilakukan.
2. Data Understanding: Tahap berikutnya adalah memahami data. Di tahap ini, mengidentifikasi dan memahami semua sumber data yang memiliki potensi sesuai dengan tujuan bisnis sangatlah penting. Pemahaman tentang sumber data, definisi data, dan penggunaan data perlu didiskusikan dengan pemilik data dan kelompok terkait agar proses analisis hingga interpretasi hasil analisis dapat mendukung pencapaian tujuan bisnis yang diinginkan.
3. Data Preparation and Modeling: Di tahap data preparation, dilakukan eksplorasi data dan pre- processing data (cleaning data, pengecekan missing value, pengecekan outlier, dan anomali variabel). Selanjutnya, metode analisis dipilih. Tahap ini akan menghasilkan data yang siap digunakan dengan kualitas yang baik untuk proses analisis agar mendapatkan insight yang valid dan tidak bias. Kemudian, pemodelan data dilakukan sesuai dengan karakteristik data, tujuan bisnis, dan persyaratan bisnis yang telah ditetapkan.
4. Interpretation and Evaluation: Setelah mendapatkan model terbaik pada tahap sebelumnya, hasil analisis disesuaikan dengan kebutuhan unit kerja terkait. Hasil analisis dievaluasi berdasarkan akurasi dan ketepatan metode, kemudian diinterpretasi sesuai dengan tujuan bisnis. Evaluasi model akan mendorong pemahaman bisnis yang didukung dengan visualisasi data untuk memudahkan penggunaan informasi.
5. Solution: Hasil analisis dan interpretasi yang telah divalidasi dan disetujui dalam bentuk report, selanjutnya akan diterapkan kesimpulan model untuk mengoptimalkan solusi terbaik dalam mencapai tujuan bisnis yang telah disepakati.
6. Decision Making: Tahapan terakhir adalah decision making. Berdasarkan model yang diperoleh, tim akan membuat keputusan dan mengambil tindakan sesuai dengan masalah bisnis yang telah ditetapkan sebelumnya. Tim DA akan berkolaborasi dan berdiskusi dengan unit kerja terkait dalam membuat keputusan dan mengambil tindakan yang sesuai dengan kebutuhan bisnis.
